...
/**
 * Detects placing blocks while standing in air or liquid.
 * Legitimate players must be on solid ground to place blocks.
 * Hacked clients can place blocks from any position.
 */
